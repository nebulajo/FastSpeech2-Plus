...
class Dataset_Sphere(Dataset):
    def __init__(
        ...
        self.basename, self.speaker, self.text, self.raw_text, self.aux_data = (
    ...
    def __getitem__(self, idx):
        ...
        polar_coordinate_path = os.path.join(
            self.preprocessed_path,
            "polar_coordinate",
            "{}-polar_coordinate-{}.npy".format(speaker, basename),
        )
        polar_coordinate = np.load(polar_coordinate_path)
    ...
    def reprocess(self, data, idxs):
        ...
        polar_coordinates = [data[idx]["polar_coordinate"] for idx in idxs]
