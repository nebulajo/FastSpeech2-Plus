...
if __name__ == "__main__":
    ...
    out_dir = "preprocessed_data_test/ESD"
    model_name = "/home/hyebit/swj/EmoSphere-TTS/audeering"
    wav_path = "preprocessed_data_test/ESD/wav/"

    filelist, emotions = load_filelist_dict(
        "/home/hyebit/swj/Expressive-FastSpeech2/raw_data/ESD/filelist.txt"
    )
